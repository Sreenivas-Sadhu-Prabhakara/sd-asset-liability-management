package com.bank.bian.assetliabilitymanagement.model;
...
/**
 * The BIAN control record for this service domain: "ALM Position Management Plan".
 *
 ...
 * to its asset type (ALM Position). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "ALM Position Management Plan";
